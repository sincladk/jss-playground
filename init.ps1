...
try {
    ...
    & $mkcert -install
    & $mkcert "*.jss_playground.localhost"
...
Add-HostsEntry "cm.jss_playground.localhost"
Add-HostsEntry "cd.jss_playground.localhost"
Add-HostsEntry "id.jss_playground.localhost"
Add-HostsEntry "www.jss_playground.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.jss_playground.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.jss_playground.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.jss_playground.localhost"
